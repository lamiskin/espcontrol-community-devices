---
title: 5-inch M5Stack Tab5 (V1)
description: "Community EspControl build for the M5Stack Tab5 (V1) — 5 inches 1280 x 720 landscape touchscreen with 24 cards, powered by ESP32-P4."
---
<!-- =============================================================================
...
# 5-inch M5Stack Tab5 (V1)

The **M5Stack Tab5 (V1)** is a 5-inch landscape
touchscreen powered by **ESP32-P4**, with room for **24 cards**
on the home screen.

Community port contributed via [PR #136](https://github.com/lamiskin/espcontrol-community-devices/pull/136) by @persuader72.
...
<EspInstallButton slug="m5stack-esp32-p4-tab5-v1" />
...
<EspInstallButton slug="m5stack-esp32-p4-tab5-v1" variant="recovery" />
...
packages:
  setup:
    ...
    file: devices/m5stack-esp32-p4-tab5-v1/packages.yaml
    refresh: 1s
```
