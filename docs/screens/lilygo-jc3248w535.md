---
title: 3.2-inch Lilygo JC3248W535
description: "Community EspControl build for the Lilygo JC3248W535 — 3.2 inches 320 x 480 portrait touchscreen with 6 cards, powered by ESP32-S3."
---
<!-- =============================================================================
...
# 3.2-inch Lilygo JC3248W535

The **Lilygo JC3248W535** is a 3.2-inch portrait
touchscreen powered by **ESP32-S3**, with room for **6 cards**
on the home screen.

Community port contributed via [PR #348](https://github.com/jtenniswood/espcontrol/pull/348) by @fbeauchamp.
...
<EspInstallButton slug="lilygo-jc3248w535" />
...
packages:
  setup:
    ...
    file: devices/lilygo-jc3248w535/packages.yaml
    refresh: 1s
```
