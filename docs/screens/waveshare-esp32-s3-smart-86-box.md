...
description: "Community EspControl build for the Waveshare ESP32-S3 Smart 86 Box — 4 inches 480 x 480 square touchscreen with 9 cards, powered by ESP32-S3."
---
<!-- =============================================================================
...
The **Waveshare ESP32-S3 Smart 86 Box** is a 4-inch square
touchscreen powered by **ESP32-S3**, with room for **9 cards**
on the home screen.

Community port contributed via [PR #293](https://github.com/jtenniswood/espcontrol/pull/293), [Issue #15](https://github.com/lamiskin/espcontrol-community-devices/issues/15) by @MrWishbone.
