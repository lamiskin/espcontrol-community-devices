...
| SenseCAP Indicator D1 4" | seeed-sensecap-indicator-d1 | Broken | community-v0.1.2-upstream.v2.6.3 | @mglev1n ([#62](https://github.com/lamiskin/espcontrol-community-devices/issues/62)) | @davidmerrique | [PR #351](https://github.com/jtenniswood/espcontrol/pull/351) |
...
| M5Stack Tab5 5" | m5stack-esp32-p4-tab5 | Broken | community-v0.6.0-upstream.v2.8.4-preview.1 | @direk ([#95](https://github.com/lamiskin/espcontrol-community-devices/issues/95#issuecomment-5521806746)) | @direk | [Issue #95](https://github.com/lamiskin/espcontrol-community-devices/issues/95) |
