...
| Waveshare ESP32-P4-WIFI6-Touch-LCD-7B 7" | waveshare-esp32-p4-touch-lcd-7b | Working | community-v0.11.0-upstream.v2.10.0 | @bassrock | @bassrock | [7B device branch](https://github.com/bassrock/espcontrol-community-devices/tree/device/waveshare-esp32-p4-touch-lcd-7b) |
